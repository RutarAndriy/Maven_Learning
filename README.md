...
|'artifactId'|Це ідентифікатор самого проекту. Найчастіше в якості ідентифікатора виступає ім'я проекту. Наприклад, `maven-assembly-plugin`. `artifactId` також допомагає знайти проект в репозиторії.|
